  ...
  for (let i = 0; i < cart.length; i++) {
    box += `
      <li
              ...
              align-items-center border-1 border-bottom"
            >
              <div
                class="item-details d-flex gap-4 flex-column 
                flex-md-row align-items-center col-4 text-center text-md-start"
              >
              ...
              <div
                class="col-3 d-flex flex-column flex-md-row 
              ...
              >
                <input
                  ...
                  disabled
                />
                <button class="btn btn-warning crudBtn editBtn" 
                onClick="editItem(${i})">edit</button>
                <button class="btn btn-danger crudBtn deleBtn" 
                onClick="deleItem(${i})" ><i class="fa-solid fa-trash-can"></i></button>
              </div>
...
function editItem(i) {
  inputsCount = document.querySelectorAll(".inputCount");
  btnsEdit = document.querySelectorAll(".editBtn");
